...
| [`orchestration/`](orchestration/) | Not a plugin: a Node runtime for deterministic scripts that dispatch Paseo agents through the `paseo` CLI -- steps with output schemas, roles, an audit log, and a human approval gate. | In use |
